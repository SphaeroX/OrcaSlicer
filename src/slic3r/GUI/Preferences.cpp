...
wxWindow* PreferencesDialog::create_general_page()
{
    ...
    auto item_random_placement = create_item_checkbox(_L("Randomize model position on load"), page, _L("Place new models at random positions on the build plate."), 50, "random_placement_on_load");
    ...
    sizer_page->Add(item_random_placement, 0, wxTOP, FromDIP(3));
